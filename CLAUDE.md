...
`agent-menu` is a personal meal-planning agent: Claude generates 4 weekly recipes, delivered via Telegram. A long-running daemon handles generation and recipe replacement via explicit slash commands.
